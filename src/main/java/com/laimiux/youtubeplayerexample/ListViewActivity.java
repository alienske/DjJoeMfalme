...
import com.laimiux.youtube.BuildConfig;
...
public class ListViewActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* ids.add("uJ_1HMAGb4k");
        ...
        mYoutubeListView.init("AIzaSyDy5IThrkxWk4wJfy-AtBxPtZgDnGoUU6I", ids, new YoutubeListView.OnListViewLoad() {
            @Override
            public void onLoad() {
                // Hide loader here.
    ...
    private void showVideo(Video video) {
        PlayerActivity.showPlayer(this, "AIzaSyAXNw9vsvarlVkEOAwYKyHUmscN9PTnnqo", video.getId());
    }
}
